...
let loginEmailValid =
  loginEmailField.getElementsByClassName("valid-feedback")[0];
let loginEmailInvalid =
  loginEmailField.getElementsByClassName("invalid-feedback")[0];
let loginPasswordValid =
  loginPasswordField.getElementsByClassName("valid-feedback")[0];
let loginPasswordInvalid =
  loginPasswordField.getElementsByClassName("invalid-feedback")[0];

const validate = (flag = false) => {
  let isValid = true;
  if (flag) signUpglobalFlag = flag;
